...
let prompt=require('prompt-sync')();
let classSize=prompt('please enter number of students:')
let numberOfTeams=prompt('please enter number of teams:')
const minimumTeamSize=Math.floor(classSize/numberOfTeams);
const NumberOfTeamWithExtraStudent=classSize%numberOfTeams;
const numberOfTeamWithMinimumTeamSize=numberOfTeams-NumberOfTeamWithExtraStudent
console.log(NumberOfTeamWithExtraStudent + "teams with" +(minimumTeamSize + 1) + "members");
console.log(numberOfTeamWithMinimumTeamSize + "team with" + minimumTeamSize + "members");
